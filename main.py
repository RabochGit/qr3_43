...
bot = telebot.TeleBot("6346115292:AAHV5jWmxdkSr-7ROGSYivpGyQgKUcUVF0Y",
...
text_poll = "Идешь на последний день марафона?"  # Можно менять текст
text_button_1 = "Конечер да!"  # Можно менять текст
text_button_2 = "Конечно нет :("  # Можно менять текст
text_button_3 = "Сомневаюсь"  # Можно менять текст
